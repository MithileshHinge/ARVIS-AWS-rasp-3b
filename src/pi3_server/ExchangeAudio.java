...
public class ExchangeAudio extends Thread{
	...
	public ExchangeAudio(InetAddress sysIP, InetAddress mobIP) throws IOException{
        ...
        dataSocket_mob = new DatagramSocket();
        dataSocket_mob.bind(new InetSocketAddress(mobIP, Main.PORT_AUDIO_UDP_MOB));
        dataSocket_mob.setSoTimeout(500);
        
        dataSocket_system = new DatagramSocket();
        dataSocket_system.bind(new InetSocketAddress(sysIP, Main.PORT_AUDIO_UDP_SYS));
	}
